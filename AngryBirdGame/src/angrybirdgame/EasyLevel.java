...
public class EasyLevel implements Screen {
    ...
    public EasyLevel(AngryBirdGame game) {
        this.game = game;
    ...
    private void initializeLevel() {
        Material wood = new Material(100, 10, new Texture(Gdx.files.internal("Wood/Wood_03-512x512.png")));
    ...
    public void render(float delta) {
        ...
        batch.draw(sling, 50, structure.y + 20, 80f, 120f);
